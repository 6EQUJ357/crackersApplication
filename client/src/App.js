...
import AddPurchase from './pages/components/addPurchase'
...
import PurchasePaymentSummary from './pages/components/purchasePaymentsummary'
...
import Purchasereport from './pages/components/purchaseReport'
import ClientWisePurchaseReport from './pages/components/clientwisePurchaseReport'
import PurchasePeriod from './pages/components/purchaseperiod'
...
import PurchasePayments from './pages/components/purchasePayments'
import PurchasePaymentDetails from './pages/components/purchasePaymentDetails'
        ...
        <company_profile_store.Provider value={[company_profile_dataa, set_company_profile_dataa]}>
          ...
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route path='/purchasepaymentsummary' element = {<PurchasePaymentSummary/>} />
              ...
              <Route path='/clientwisepurchasereport' element = {<ClientWisePurchaseReport/>} />
              <Route path='/purchaseperiod' element = {<PurchasePeriod/>} />
              ...
              <Route path='/purchasepayment' element = {<PurchasePayments />} />
              <Route path='/purchasepaymentdetails' element ={<PurchasePaymentDetails />}/>
