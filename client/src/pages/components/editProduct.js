...
import ReuseEditProduct from '../reusecomponents/reuseEditProduct.js'
...
const EditProduct = () => {
  ...
  useEffect(()=>{ 
      axios.get(`${API_BASE_URL}/editproduct`, {
          headers :{
  ...
  return (
    <div>
    <ReuseEditProduct value1={resdata} value2  = {signuphandle} value3 = {company_profile_dataa}/>
