...
import ReusePurchasePayments from '../reusecomponents/reusePurchasePayments.js';
...
const PurchasePayments = () => {
 ...
 // const [token, setToken] = useContext(store);
  ...
  useEffect(()=>{ 
      axios.get(`${API_BASE_URL}/purchasepayment`, {
          headers :{
  ...
  return (
    <div>
      {resdata.userType === "super Admin" && <ReusePurchasePayments value1={resdata} value2  = {signuphandle} value3 = {company_profile_dataa}/>}
      {resdata.userType === "admin" && <ReusePurchasePayments value1={resdata} value2  = {signuphandle} value3 = {company_profile_dataa}/>}
