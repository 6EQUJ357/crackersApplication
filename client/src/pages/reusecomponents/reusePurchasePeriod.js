...
const ReusePurchasePeriod = (params) => {
...
const handleFilterMonth = ()=>{
    const filteredData = purchase.filter(obj => {
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 className="mb-sm-0">Purchase Period</h4>

                                <div className="page-title-right">
                                    <ol className="breadcrumb m-0">
                                        <li className="breadcrumb-item"><a href="#a">Purchase</a></li>
                                        <li className="breadcrumb-item active">Purchase Period</li> 
                                    </ol>
                                </div>
...
export default ReusePurchasePeriod