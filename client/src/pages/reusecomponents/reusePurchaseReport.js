...
const ReusePurchseReport = (params) => {
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 className="mb-sm-0">Purchase Report</h4>
                                    ...
                                    <div className="table-responsive table-card">
                                        ...
                                        <thead>
                                            ...
                                            <tbody>
                                                  ...
                                                  {currentData.length >0 ? currentData.filter(list=>list.rows.map(list=>list.productname)[0].toLowerCase().startsWith(searchproduct.toLowerCase()) || list.purchaseno.startsWith(searchproduct)).map(res=>
...
export default ReusePurchseReport