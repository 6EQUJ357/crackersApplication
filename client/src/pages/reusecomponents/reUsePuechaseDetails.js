...
const ReusePurchasedetails = (params) => {
    ...
    //console.log(purchaseData);
     ...
     const downloadPDF = ()=>{
         ...
         html2canvas(input).then((canvas)=>{
             ...
             pdf.save(`${purchaseData.purchaseno}-${params.value3?.[0].company_name}.pdf`);
     ...
     const handlePrint = useReactToPrint({
        ...
        documentTitle : `${purchaseData.purchaseno}-${params.value3?.[0].company_name}`,
                            ...
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div className="page-title-right">
                                    <ol className="breadcrumb m-0">
                                        ...
                                        <li className="breadcrumb-item active">Purchase Details</li>
                                    </ol>
                                </div>
                                ...
                                {params.value3 &&
                                 ...
                                 <div className="row p-4">
                                     <div className="col-lg-12">
                                         <h3 className="fw-bold mb-4">Purchase No : {purchaseData.purchaseno}</h3>
                                         <div className="row g-4">
                                             <div className="col-lg-4 col-4">
                                                 <p className=" mb-1 text-uppercase fw-bold fs-14">Dealer (Company) Name : {purchaseData.vendorname}</p> 
                                                 {/* <h5 className="fs-16 mb-0"><span id="invoice-no">GST No : {purchaseData.vendorGSTno}</span></h5> */}
                                             </div>
                                             {/*end col*/}
                                             <div className="col-lg-4 col-4">
                                                 <p className="text-muted mb-1 text-uppercase fw-medium fs-14">Date</p>
                                                 <h5 className="fs-16 mb-0"><span id="invoice-date">{new Date(purchaseData.dateofpurchase).toLocaleString().substr(0,9)}</span>
                                                  {/* <small className="text-muted" id="invoice-time">{new Date(purchaseData.dateofpurchase).toLocaleString()}</small> */}
                                                  </h5>
                                             </div>
                                             {/*end col*/}
                                             <div className="col-lg-4 col-4">
                                                 <p className="text-muted mb-1 text-uppercase fw-medium fs-14">Payment Status</p>
                                                 <span className="badge badge-soft-success fs-11" id="payment-status">{purchaseData.paymentstatus}</span>
                                             </div>
                                             {/*end col*/}
                                             {/* <div className="col-lg-6 col-6">
                                                 <p className="text-muted mb-1 text-uppercase fw-medium fs-14">Total Amount</p>
                                                 <h5 className="fs-16 mb-0">₹<span id="total-amount">{purchaseData.totalAmount}</span></h5>
                                             </div> */}
                                             {/*end col*/}
                                         </div>
                                     </div>
                                 ...
                                 <div className="row p-4 border-top border-top-dashed">
                                     <div className="col-lg-9">
                                         <div className="row g-3">
                                             ...
                                             <div className="col-6">
                                                 <h6 className="text-muted text-uppercase fw-semibold mb-3">Billing Address</h6>
                                                 {/* <p className="fw-medium mb-2" id="shipping-name">{purchaseData.vendorname}</p> */}
                                                 <p className="text-muted mb-1" id="shipping-address-line-1">{purchaseData.vendoraddress}</p>
                                                 <p className="text-muted mb-1"><span id="shipping-phone-no">Phone: (+91) {purchaseData.vendornumber}</span></p>
                                             </div>
                                             {/*end col*/}
                                         </div>
                                         {/*end row*/}
                                     ...
                                     <div className="col-lg-3">
                                             ...
                                             <h3 className="fw-bold mb-2">₹ {purchaseData.totalAmount}</h3>
                                             <span className="badge badge-soft-success fs-12">Due Date: {new Date(purchaseData.dateofpurchase).toLocaleString().substr(0,10)}</span>
                                     </div>

                                     <div className="col-lg-4 col-4">
                                            <p className=" mb-1 text-uppercase fw-medium fs-14">Category</p>
                                            <span className="badge badge-soft-success fs-11" id="payment-status">{purchaseData.producttype}</span>
                                        </div>
                                     ...
                                     <div className="col-lg-12">
                                         <div className="card-body p-4">
                                                 ...
                                                 <table className="table table-borderless text-center table-nowrap align-middle mb-0">
                                                     <thead>
                                                         <tr className="table-active">
                                                             ...
                                                             <th scope="col" style={{textAlign:"left", width:"200px"}}>Product Details</th>
                                             ...
                                             <div className="border-top border-top-dashed mt-2">
                                                 <table className="table table-borderless table-nowrap align-middle mb-0 ms-auto" style={{width: "250px"}}>
                                                     <tbody>
                                                         {/* <tr>
                                                             <td>Sub Total</td>
                                                             <td className="text-end">{purchaseData.subtotal}</td>
                                                         </tr>
                                                         <tr>
                                                             <td>SGST (%)</td>
                                                             <td className="text-end">{purchaseData.SGST}</td>
                                                         </tr>
                                                         <tr>
                                                             <td>CGST (%)<small className="text-muted"></small></td>
                                                             <td className="text-end">{purchaseData.CGST}</td>
                                                         </tr> */}
                                                         
                                                         <tr className="border-top border-top-dashed fs-15">
                                                             <th scope="row">Total Amount</th>
                                                             <th className="text-end">₹ {purchaseData.totalAmount}</th>
                                                         </tr> 
                                                     </tbody>
                                                 </table>
                                                 {/*end table*/}
                                             ...
                                             <div className="mt-3">
                                                 ...
                                                 <p className="text-muted mb-1">Payment Method: <span className="fw-medium" id="payment-method">{purchaseData.paymentmethod}</span></p>
                                                 <p className="text-muted mb-1">Card Holder: <span className="fw-medium" id="card-holder-name">{purchaseData.holdername}</span></p>
                                                 <p className="text-muted mb-1">Card Number: <span className="fw-medium" id="card-number">xxxx xxxx xxxx {purchaseData.cardnumber.substr(15, 4)}</span></p>
                                                 <p className="text-muted">Total Amount: <span className="fw-medium" id="">₹ </span><span id="card-total-amount">{purchaseData.totalAmount}</span></p>

                                                 {purchaseData.paymentstatus === "Pending" && 
                                                    <>
                                                    <p className="text-muted">Received Amount: <span className="fw-medium" id="">₹ </span><span id="card-total-amount">{purchaseData.receiveAmount}</span></p>

                                                    {purchaseData.PayAmount &&
                                                    <p className="text-muted">Pay Amount: <span className="fw-medium" id="">₹ </span><span id="card-total-amount">{purchaseData.PayAmount}</span></p>
                                                    }

                                                    <p className="text-muted">Balance Amount To Be Paid: <span className="fw-medium" id="">₹ </span><span id="card-total-amount">{Number(purchaseData.totalAmount - purchaseData.receiveAmount).toFixed(2)}</span></p>
                                             ...
                                             {/* <div className="hstack gap-2 justify-content-end d-print-none mt-4">
                                                 ...
                                                 <button onClick={downloadPDF} className="btn btn-primary"><i className="ri-download-2-line align-bottom me-1"></i> Download</button>
                                                 <Link to="/purchase" className="btn btn-danger addMembers-modal" ><i class="las la-arrow-left"></i> Back To Purchase</Link>
                         ...
                         <div className="hstack gap-2 justify-content-end d-print-none mt-4">
                            ...
                            <div className="dropdown header-item">
                                    ...
                                    {/* item*/}
                                        ...
                                        <Downloadtoexcel data={purchaseData} fileName = {`${purchaseData.purchaseno}-${params.value3?.[0].company_name}`}/>
                                    </div>
                                </div>
...
export default ReusePurchasedetails