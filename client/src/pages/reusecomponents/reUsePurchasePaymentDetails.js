...
const ReusePurchasePaymentdetails = (params) => {
   ...
   // console.log("sales", salesPaymentData);
    ...
    let filterData = invoice.filter((list)=>list.purchaseno === salesPaymentData.purchaseno); 
   // console.log("first", filterData)

    let filterDBdata = salesPaymentDataFromDB.filter(list=> list.purchaseno === salesPaymentData.purchaseno);
    //console.log("dbqwwewe", filterDBdata);


    useEffect(()=>{
        axios.get(`${API_BASE_URL}/getpurchasetransaction`).then(res=>setinvoice(res.data)).catch(err=>console.log(err));

         axios.get(`${API_BASE_URL}/getpurchasepayment`).then(res=>setSalesPaymentDataFromDB(res.data)).catch(err=>console.log(err));  
    },[])
       ...
       const downloadPDF = (filter)=>{
           ...
           html2canvas(input,{}).then(canvas=>{
               ...
               pdf.save(`${filter.purchaseno}-${params.value3?.[0].company_name}.pdf`);
       ...
       const handlePrint = useReactToPrint({
           ...
           documentTitle : `${filterData.purchaseno}-${params.value3?.[0].company_name}`,
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 className="mb-sm-0">Purchase Payments Details</h4>
                                        ...
                                        <div className="col-lg-12" >
                                            <div className="card-body p-4" >
                                                ...
                                                <div className="mt-3">
                                                    ...
                                                    <p className="text-muted mb-1">Card Holder: <span className="fw-medium" id="card-holder-name">{filterData.holdername}</span></p>
                            ...
                            <div className="hstack gap-2 justify-content-end d-print-none mt-4">
                                ...
                                <div className="dropdown header-item">
                                    ...
                                    {/* item*/}
                                        ...
                                        <Downloadtoexcel data={filterData} fileName = {`${filterData.purchaseno}-${params.value3?.[0].company_name}`}/>
                                    </div>
                                </div>

                                <Link to="/purchasepayment" className="btn btn-danger addMembers-modal" ><i classname="las la-arrow-left"></i> Back To Purchase Payment</Link>
...
export default ReusePurchasePaymentdetails