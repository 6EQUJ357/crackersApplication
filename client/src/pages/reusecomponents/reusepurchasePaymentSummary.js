...
const ReusePurchasePaymentsummary = (params) => {
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 className="mb-sm-0">Purchase Payment Summary</h4>
                        ...
                        <div className="col-sm-4">
                            <div className="d-flex">
                                <div className="search-box">
                                    <input type="text" className="form-control" id="searchMemberList" placeholder="Search for invoiceNo or Company" name='search' onChange={(e)=>setSearch(e.target.value)} />
                                        ...
                                        <table className="table table-hover table-nowrap align-middle mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><p className="fw-medium mb-0">{list.purchaseno}</p></td>
                                                    <td>
...
export default ReusePurchasePaymentsummary